...
public class C2DMessaging {
	 ...
	 */
	public void sendWithRetry(String token, String collapseKey, String name1,
	...
	public boolean sendNoRetry(String token, String collapseKey, String name1,
			String value1, String name2, String value2, String name3,
			String value3) throws IOException {
	...
	public boolean sendNoRetry(String token, String collapseKey,
			String... nameValues) throws IOException {
	...
	private void retry(String token, String collapseKey,
		...
		try {
			TaskOptions url = TaskOptions.Builder.url(C2DMRetryServlet.URI)
					.param(C2DMessaging.PARAM_REGISTRATION_ID, token).param(
							C2DMessaging.PARAM_COLLAPSE_KEY, collapseKey);
			if (delayWhileIdle) {
