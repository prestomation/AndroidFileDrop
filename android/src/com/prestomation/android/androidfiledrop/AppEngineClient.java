...
public class AppEngineClient {
	...
	static final String BASE_URL = "https://androidfiledroptest.appspot.com";
	...
	public HttpResponse makeRequest(String urlPath, List<NameValuePair> params)
			throws Exception {
		HttpResponse res = makeRequestNoRetry(urlPath, params);
		/*
		 * if (res.getStatusLine().getStatusCode() == 500) { res =
		 * makeRequestNoRetry(urlPath, params, true); }
		 */
		return res;
	}
